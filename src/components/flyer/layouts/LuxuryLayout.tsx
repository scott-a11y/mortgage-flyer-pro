            ...
            <div className="flex items-center gap-4 w-[240px]">
              ...
              <div className="flex flex-col min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white font-serif text-[20px] tracking-wide leading-tight truncate">{data.broker.name}</div>
                  {data.company.logo && (
                ...
                <div className="text-[8px] text-slate-500 uppercase tracking-widest mt-1.5 leading-relaxed">
                  NMLS #{data.broker.nmls} • {data.broker.phone}<br />
                  {data.broker.email}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 w-[240px] flex-row-reverse">
              ...
              <div className="flex flex-col items-end min-w-0">
                <div className="flex items-center justify-end gap-2 mb-1">
                  {data.realtor.logo && (
                    <img src={data.realtor.logo} alt="Brokerage" className="h-5 w-auto object-contain opacity-80" />
                  )}
                  <div className="text-white font-serif text-[20px] tracking-wide leading-tight truncate">{data.realtor.name}</div>
                </div>
                ...
                <div className="text-[8px] text-slate-500 tracking-widest mt-1 lowercase leading-relaxed text-right">
                  {data.realtor.phone}<br />
                  {data.realtor.email}
                </div>
              </div>
            </div>
